...
export default class ListEvents extends HiveWorkerBase implements IGraphEndpointWorker {
    public execute = async (
        customArgs: Args = { page: 1, perPage: 20, visibility: 4 }
        ...
        try {
            ...
            const { page, perPage, visibility } = value as Args;
...
export async function listEvents(page: number, perPage: number, visibility: number): Promise<PageType<EventType>> {
