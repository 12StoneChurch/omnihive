...
export const getEventById = async (id: number): Promise<EventType> => {
    const graph = GraphService.getSingleton();

    return await Promise.all([
        new Promise<SelectEventTagResult>(async (resolve, reject) => {
            try {
        ...
        new Promise<SelectEventResult>(async (resolve, reject) => {
            try {
